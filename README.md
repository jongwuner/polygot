...
- **Save**: 설정된 경우 확장과 같은 Obsidian 경로로 저장, 없으면 `.md` 다운로드

---

## Chrome Extension

웹 브라우저에서 텍스트를 드래그하고 단축키를 누르면 번역 후 확장 큐에 저장하고, 필요할 때 Obsidian으로 보냅니다.
...
**방법 3 — 단축키**
1. 텍스트 선택 후 `Alt+T`
2. 바로 번역 + 큐 저장 (단축키 변경: `chrome://extensions/shortcuts`)
...
팝업의 Queue 버튼으로 필요할 때만 Obsidian에 저장할 수 있습니다.

### Popup Quick Translate

확장 프로그램 아이콘을 클릭하면 팝업에서 직접 번역하고 큐를 관리할 수 있습니다.
